...
2. Analyze real-world traffic congestion patterns

3. Identify pollution hotspots in urban areas
...
- Gathered real-world datasets related to traffic volume, carpooling practices, and environmental emissions

- Integrated data from multiple sources into a unified analytical dataset

2. Data Preprocessing

- Cleaned and normalized traffic and emissions data

- Handled missing values and inconsistencies

- Engineered features relevant to congestion and emissions analysis

3. Statistical Modeling

- Built regression models to study correlations between carpool adoption rates and CO₂ emissions

- Evaluated model performance and statistical significance of predictors

- Analysis & Visualization

- Performed exploratory data analysis (EDA)

- Visualized congestion patterns and pollution hotspots
...
- Traffic congestion and pollution are spatially concentrated, suggesting targeted intervention opportunities
